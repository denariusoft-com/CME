	...
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			<ul>
				...
				<li class="{{ Request::is('add_jobsheet') ? 'active' : '' }}"> 
				<a href="{{ route('add_jobsheet') }}"><i class="la la-tachometer"></i> <span>Jobsheet</span></a>
				</li>
				...
				<li class="submenu">
					...
					<ul style="display:{{ Request::is(array('reports*','pilotage_summary')) ? 'block' : ' none' }}">
						<li class="{{ Request::is('reports*') ? 'active' : '' }}"><a href="{{ url('reports')}}">STS Summary Report</a></li>
						<li class="{{ Request::is('pilotage_summary') ? 'active' : '' }}"><a href="{{ route('reports.pilotage_summary')}}">Pilotage Summary Report</a></li>
