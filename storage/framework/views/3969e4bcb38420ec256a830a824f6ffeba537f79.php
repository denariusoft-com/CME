...
<!-- Datetimepicker CSS -->
<link rel="stylesheet" href="<?php echo e(asset('public/assets/build/css/bootstrap-datetimepicker.min.css')); ?>">
		
<!-- Datetimepicker JS -->
<script src="<?php echo e(asset('public/assets/js/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/build/js/bootstrap-datetimepicker.min.js')); ?>"></script>	
<!-- Fontawesome CSS -->
<link rel="stylesheet" href="<?php echo e(asset('public/assets/css/font-awesome.min.css')); ?>">

<!-- Lineawesome CSS -->
<link rel="stylesheet" href="<?php echo e(asset('public/assets/css/line-awesome.min.css')); ?>">
...
<script src="<?php echo e(asset('public/assets/jquery.validate.js')); ?>"></script>
...
<!-- Chart JS -->
<script src="<?php echo e(asset('public/assets/plugins/morris/morris.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/plugins/raphael/raphael.min.js')); ?>"></script>
<!--<script src="<?php echo e(asset('public/assets/js/chart.js')); ?>"></script>-->
...
</script><?php /**PATH D:\php7\htdocs\laravel\CME\resources\views/header/head-script.blade.php ENDPATH**/ ?>