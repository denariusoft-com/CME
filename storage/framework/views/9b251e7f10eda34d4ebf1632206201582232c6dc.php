    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
				<!-- Page Content -->
				<?php echo $__env->make('content.ratemaster_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!-- /Page Content -->
            </div>
			<!-- /Page Wrapper -->
...
</html><?php /**PATH D:\php7\htdocs\laravel\CME\resources\views/master/ratemaster/list.blade.php ENDPATH**/ ?>